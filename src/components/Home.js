...
function Home() {
    return (
        <div id="maindiv">
            <center>
                <h1> I'm <span class="text-warning">SHAIK FARHAN</span></h1>
                ...
                <br></br>
                <a href="https://www.linkedin.com/in/farhan-shaik-90044323a/" target="_blank" rel="noopener noreferrer">
                    <Linkedin size={35}  color = "black" className="rounded mx-4" />
                </a>
                <a href="https://www.instagram.com/farhan_2__/" target="_blank" rel="noopener noreferrer">
